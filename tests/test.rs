...
",
    ...
    for changelog in &changelogs {
        ...
        assert_eq!(releases[0].title, "0.2.0");
        assert_eq!(trim(&releases[0].notes), "0.2.0.");

        assert_eq!(releases["0.2.0"].title, "0.2.0");
        assert_eq!(trim(&releases["0.2.0"].notes), "0.2.0.");

        assert_eq!(releases["0.1.0"].title, "0.1.0");
        assert_eq!(trim(&releases["0.1.0"].notes), "0.1.0.");
    }
}
