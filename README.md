...
All releases are [immutable](https://docs.github.com/en/code-security/concepts/supply-chain-security/immutable-releases) and releases since 0.6.16 publish [artifact attestations](https://docs.github.com/en/actions/concepts/security/artifact-attestations).
...
# Download binary.
curl --proto '=https' --tlsv1.2 -fsSL -o parse-changelog.tar.gz "https://github.com/taiki-e/parse-changelog/releases/latest/download/parse-changelog-${host}.tar.gz"
...
```text
Calculated digest for parse-changelog.tar.gz: sha256:<hash256>
Resolved tag v<version> to sha1:<hash1>
Loaded attestation from GitHub API

✓ Verification succeeded! parse-changelog.tar.gz is present in release v<version>
```
...
```text
Loaded digest sha256:<hash256> for file://parse-changelog.tar.gz
...
- Attestation #1
  - Build repo:..... taiki-e/parse-changelog
